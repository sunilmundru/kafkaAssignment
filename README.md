...
```PowerShell
java -cp .\target\kafkaAssignment-1.0-SNAPSHOT-ja
r-with-dependencies.jar com.sunil.mundru.CustomConsumer
```
...
```PowerShell
java -cp .\target\kafkaAssignment-1.0-SNAPSHOT-ja
r-with-dependencies.jar com.sunil.mundru.CustomProducer
```
